...
class Testk3zkutil(unittest.TestCase):
    ...
    def test_permission_convert_case(self):
        ...
        self.assertEqual(['CREATE', 'DELETE', 'READ', 'WRITE', 'ADMIN'],
                         k3zkutil.perm_to_long('cdrwa', lower=False))

        self.assertEqual(['CREATE', 'DELETE', 'READ', 'WRITE', 'ADMIN'],
                         k3zkutil.perm_to_long('CDRWA', lower=False))

        self.assertEqual(['create', 'delete', 'read', 'write', 'admin'],
                         k3zkutil.perm_to_long('CDRWA'))

        self.assertEqual('CDRWA',
                         k3zkutil.perm_to_short(['create', 'delete', 'read', 'write', 'admin'],
                                              lower=False))
            ...
            ('/node3', {
                ...
                'node31': {
                    ...
                    'node311': {
                        '__acl__': {'aa': 'rwca', 'cc': 'r'},
                        '__val__': b'{}',
                        'node3111': {'__acl__': {'aa': 'rwca', 'cc': 'r'},
                                     '__val__': b'{}'},
                        'node3112': {'__acl__': {'aa': 'rwca', 'cc': 'r'},
                                     '__val__': b'{}'}}}}))
...
class TestWait(unittest.TestCase):
    ...
    def test_wait_absent_timeout(self):
        ...
        for wait_time in (
            ...
            with k3ut.Timer() as t:
                self.assertRaises(k3zkutil.ZKWaitTimeout,
                                  k3zkutil.wait_absent,
